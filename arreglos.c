...
{"tengo","que","irme"},{"acabo","el","tiempo"},{"hasta","luego"}},
...
{{"pueden"},{"perdon"},{"disculpa"},{"debo"},{"deberia"},{"lo","siento"},{"lamento"},
{"maldito"},{"desgraciado"}},

{{"paso"},{"ocurre"},{"ocurrio"},{"cayo"},{"lanzo"},{"avento"},{"hizo"},{"hice"},
{"logro"},{"logre"},{"llego"},{"llegue"},{"soy"},{"estoy"},{"era"},{"fue"},{"perdio"},
{"perdi"},{"gano"},{"gane"},{"abuso"},{"abusa"},{"exagera"},{"trauma"},{"karma"},
{"dolor"},{"duele"}},
...
{"aguantar"},{"divertido"},{"divertida"},{"nauseas"},{"asco"},{"pena"}},

{{"no"},{"contrario"},{"malo"},{"mala"},{"pesimo"},{"pesima"},{"terrible"},{"horrible"},
